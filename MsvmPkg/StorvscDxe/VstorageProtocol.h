...
STATIC_ASSERT((sizeof(VMSCSI_REQUEST) % 4) == 0, "invalid definition");

#define VMSTORAGE_SIZEOF_VMSCSI_REQUEST_REVISION_1 OFFSET_OF(VMSCSI_REQUEST, Reserve)

STATIC_ASSERT(VMSTORAGE_SIZEOF_VMSCSI_REQUEST_REVISION_1 == 0x24, "invalid definition");

#define VMSTORAGE_SIZEOF_VMSCSI_REQUEST_REVISION_2 (SIZEOF_THROUGH_FIELD(VMSCSI_REQUEST, QueueSortKey))

STATIC_ASSERT(VMSTORAGE_SIZEOF_VMSCSI_REQUEST_REVISION_2 == 0x34, "invalid definition");
...
STATIC_ASSERT((sizeof(VMSTORAGE_CHANNEL_PROPERTIES) % 4) == 0, "invalid definition");
...
STATIC_ASSERT((sizeof(VMSTORAGE_PROTOCOL_VERSION) % 4) == 0, "invalid definition");
...
STATIC_ASSERT((sizeof(VMFC_WWN_PACKET) % 4) == 0, "invalid definition");
...
STATIC_ASSERT((sizeof(VSTOR_CLIENT_PROPERTIES) % 4) == 0, "invalid definition");
...
STATIC_ASSERT((sizeof(VSTOR_ASYNC_REGISTER_PACKET) % 4) == 0, "invalid definition");
...
STATIC_ASSERT((sizeof(VSTOR_NOTIFICATION_PACKET) % 4) == 0, "invalid definition");
...
STATIC_ASSERT((sizeof(VSTOR_PACKET) % 8) == 0, "invalid definition");
...
STATIC_ASSERT(VMSTORAGE_SIZEOF_VSTOR_PACKET_REVISION_1 == 0x30, "invalid definition");
...
STATIC_ASSERT(VMSTORAGE_SIZEOF_VSTOR_PACKET_REVISION_2 == 0x40, "invalid definition");
